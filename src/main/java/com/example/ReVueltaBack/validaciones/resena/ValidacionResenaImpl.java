...
@Component
public class ValidacionResenaImpl implements IValidacionResena{
    ...
    @Override
    public void validar(Resena resenas) {
    validarTituloObligatorio(resenas.getTitulo());
    validarComentarioLongitud(resenas.getComentario());
    validarFechaNoFutura(resenas.getFecha());
    }
