...
public class ImagenesPrendaRequestDTO {
    ...
    public ImagenesPrendaRequestDTO() {
    }

    public ImagenesPrendaRequestDTO(String url, Boolean esPrincipal, Integer orden,
    ...
    public ImagenPrenda toEntity() {
        ...
        entidad.setTamaño_KB(this.tamanoKb);
