...
public class TruequeRequestDTO {
    ...
    public TruequeRequestDTO() {
    }

    public TruequeRequestDTO(String estado, LocalDate fechaPropuesta, LocalDate fechaRespuesta,
     ...
     * IUsuarioRepositorio.findById(...)) y sobreescribe esas referencias
