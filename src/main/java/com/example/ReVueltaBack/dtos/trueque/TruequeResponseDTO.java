...
public class TruequeResponseDTO {
    ...
    public TruequeResponseDTO() {
    }

    public TruequeResponseDTO(UUID id, String estado, LocalDate fechaPropuesta, LocalDate fechaRespuesta,
     ...
     */
    public static TruequeResponseDTO fromEntity(Trueque trueque) {
        if (trueque == null) {
            return null;
        }

        TruequeResponseDTO dto = new TruequeResponseDTO();
