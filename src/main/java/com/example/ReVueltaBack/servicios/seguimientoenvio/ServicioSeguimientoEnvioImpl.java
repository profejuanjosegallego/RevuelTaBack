...
@Service
public class ServicioSeguimientoEnvioImpl implements IServicioSeguimientoEnvio {
    ...
    public ServicioSeguimientoEnvioImpl(ISeguimientoEnvioRepositorio repositorioSeguimientoEnvio,
